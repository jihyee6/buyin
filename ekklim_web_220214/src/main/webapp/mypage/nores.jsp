		...
		<div class="content">
			...
			<div class="maintext">
				...
				<div class="tabmenu">
					<!-- 예약/취소내역 택 div -->
					<div class="tabnav">
						<div class="reservationlist" onclick="location.href='nores'" style="border: 1px solid #707070; border-top: 3px solid #4366A3; color: #242424;"><p>예약내역</p></div>
						<div class="canclelist" onclick="location.href='nocan'" ><p>취소내역</p></div>
					</div>
					<!-- <div class="date">
						<input type="date">
					</div> -->
					<!-- 예약내역 없음 div -->
					<div class="no">
						<img alt="달력아이콘" src="../images/icon/calandarIcon.png">
						<h2>선택하신 날짜의 예약내역이 없습니다.</h2>
					</div>
				</div>
			</div>
		</div>
