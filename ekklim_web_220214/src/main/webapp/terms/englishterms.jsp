...
<body>
	<div class="t_text">
		...
		<hr>
		<div class="t_button">
			<button type="button" onclick="location.href='termsofuse'" style="background: #707070; color: white; ">이용약관</button>
			<button type="button" onclick="location.href='privacy'">개인정보처리방침</button>
			<button type="button" onclick="location.href='email'">이메일무단수집거부</button>
			<button type="button" onclick="location.href='marketing'">마케팅활용동의</button>
		</div>
		<div class="language">
			<div class="korean" onclick="location.href='termsofuse'"><p>한글</p></div>
			<div class="english" onclick="location.href='englishterms'"  style="border: 1px solid #707070; border-top: 3px solid #C3A58A; color: #242424; "><p>영문</p></div>
		</div>
...
<br>
These terms and conditions are aimed at stipulating basic matters concerning the terms and procedures of use of the A.C.C. design hotel online service (hereinafter referred to as "service") provided by the A.C.C. design hotel (hereinafter referred to as "hotel").<br>
<br>
