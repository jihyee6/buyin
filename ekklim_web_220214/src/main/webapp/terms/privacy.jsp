...
<body>
	<div class="t_text">
		...
		<div class="t_button">
			...
			<button type="button" onclick="location.href='privacy'" style="background: #707070; color: white; ">개인정보처리방침</button>
		...
		<div class="language">
			<div class="korean" onclick="location.href='privacy'" style="border: 1px solid #707070; border-top: 3px solid #C3A58A; color: #242424; "><p>한글</p></div>
			<div class="english" onclick="location.href='englishprivacy'"><p>영문</p></div>
		</div>
...
개인정보의 수집항목<br>
 <br>
A.C.C 디자인 호텔은 별도의 회원가입 절차 없이 대부분의 컨텐츠에 자유롭게 접근할 수 있습니다. A.C.C 디자인 호텔은 서비스를 이용하시고자 할 경우 다음의 정보를 입력해주셔야 하며,<br>
...
② 귀하의 동의를 받아 보유하고 있는 거래정보 등을 귀하께서 열람을 요구하는 경우 A.C.C 디자인 호텔은  지체없이 그 열람,확인 할 수 있도록 조치합니다.<br>
 <br>
개인정보의 수집목적 및 이용목적<br>
 <br>
A.C.C 디자인 호텔은 개인정보보호 관련 주요 법률인 ‘정보통신망 이용촉진 및 정보보호 등에 관한 법률’을 준수하기 위하여 개인정보취급방침을 제정하고 이를 준수하고 있습니다.<br>
 <br>
...
③ A.C.C 디자인 호텔은 개인정보의 이용목적의 달성 및 해지시까지 개인정보를 보유, 이용하되 개인정보의 수집 및 이용 목적이 달성된 때에는 고객의 개인정보를 지체없이 파기합니다.​ <br>
<br>
		</p>
