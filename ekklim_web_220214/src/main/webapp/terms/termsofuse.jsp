...
<body>
	<div class="t_text">
		...
		<div class="language">
			<div class="korean" onclick="location.href='termsofuse'" style="border: 1px solid #707070; border-top: 3px solid #C3A58A; color: #242424; "><p>한글</p></div>
			<div class="english" onclick="location.href='englishterms'"><p>영문</p></div>
		</div>
...
제 1 조 (목적)<br>
 <br>
이 약관은 A.C.C 디자인호텔(이하 "호텔"이라 합니다)이 제공하는 A.C.C 디자인 호텔 온라인 서비스(이하 "서비스"라 한다)의 이용 조건 및 절차에 관한 기본적인 사항을 규정함을 목적으로 합니다.<br>
 <br>
